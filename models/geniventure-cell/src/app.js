        ...
        model.addListener( () => {
          ...
          if (document.getElementById("cellshape_0_Layer0_0_FILL")) {
            ...
            if (model.world.getProperty("open_gates") && !model.world.getProperty("albino")) {
              document.getElementById("backcell_x5F_color").style["fill-opacity"] = Math.max(0.5, saturation)
              document.getElementById("backcell_x5F_color").style["fill"] = colorStr
            } else {
              document.getElementById("backcell_x5F_color").style["fill-opacity"] = 1
              document.getElementById("backcell_x5F_color").style["fill"] = "rgb(180,180,180)"
